...
def predict():
    ...
    if file and allowed_file(file.filename):
        ...
        # --- Video Processing ---
            ...
            # --- FIX: Reworked frame explanation logic ---
                ...
                if frame_id % int(fps) == 0:
                    ...
                    if faces:
                        ...
                        if face_crop.size > 0:
                            ...
                            # --- FIX: Save the best "REAL" and "FAKE" frames ---
                            # Save the most "real" looking frame
                            if pred > best_real_score:
                                best_real_score = pred
                                frame_to_explain_real = frame.copy()

                            # Save the most "fake" looking frame
            ...
            # --- FIX: Use the correct frame for explanation ---
            ...
            return jsonify({
                ...
                'prediction': prediction_label,  # <-- FIX: Was 'prediction'
                'confidence': confidence,
                'reason': reason
            })
